        ...
        for i in range(0, len(all_item_ids), 50):
            ...
            for base in base_items:
                ...
                if matching_models and matching_models.get("model"):
                    ...
                    sku = base.get("item_sku", "").strip() # TUYỆT ĐỐI CHỈ LẤY SKU THỰC TẾ (QUY TẮC 19)
                    
                    # 🌟 SỬA LỖI 999: Lấy tồn kho thực từ API, nếu không có trả về 0 để tránh ảo kho
                    stock = 0
                ...
                all_products_data.append({
                    ...
                    "shop": shop_name,
                    "platform": "shopee",
                    "parent_sku": base.get("item_sku", "") # 🌟 LẤY ĐÚNG MÃ SẢN PHẨM GỐC TỪ SHOPEE ĐỂ GỬI LÊN
                })
