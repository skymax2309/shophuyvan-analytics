...
function _shopee(row, shop) {
  ...
  return {
    ...
    shipping_provider: _str(row["Đơn vị vận chuyển"]),
...
function _tiktok(row, shop) {
  ...
  return {
    ...
    shop,
    order_id,
    order_status:    _str(row["Order Status"]),
    shipping_provider: _str(row["Shipping Provider"]),
...
function _lazada(row, shop) {
  ...
  return {
    ...
    shop,
    order_id,
    order_status:    _str(row["status"]),
    shipping_provider: _str(row["shippingProvider"]),
